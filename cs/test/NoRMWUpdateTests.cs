...
namespace FASTER.test
{
    ...
    [TestFixture]
    internal class NoRMWUpdateTests
    {
        ...
        public void Setup()
        {
            log = Devices.CreateLogDevice(TestContext.CurrentContext.TestDirectory + "\\NoRMWUpdateTests.log", deleteOnClose: true);
            objlog = Devices.CreateLogDevice(TestContext.CurrentContext.TestDirectory + "\\NoRMWUpdateTests.obj.log", deleteOnClose: true);
        ...
        public void SyncRMW()
        {
            using var session = fht.For(new NoRMWUpdateTestFunctions()).NewSession<NoRMWUpdateTestFunctions>(noRmwUpdate:true);
    ...
    internal class NoRMWUpdateTestFunctions : SimpleFunctions<int, RMWValue, Status>
    {
        ...
        public override bool InPlaceUpdater (ref int key, ref RMWValue input, ref RMWValue value)
        {
            Assert.Fail("InPlaceUpdater");
            return true;
        }
